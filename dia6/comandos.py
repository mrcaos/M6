...
django-admin startproject onlyflan  -----> generamos el proyecto , si tiene el mismo nombre del entorno virtual hacemos cd..  
creamos una carpeta x , entramos y generamos el startproject

cd onlyflan --> entramos al proyecto
...
creamos la carpeta templates una vez creada llevamos el index.html
