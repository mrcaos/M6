...
# conda create --name mi-proyecto-django

# conda activate mi-proyecto-django
...
# python manage.py runserver -----> PARA VER EL PROYECTO EJECUTANDOCE EN HTML

# python manage.py startapp polls ----> AGREGA APP AL PROYETO O UNA APLICACION DENTRO DE LA APLICACION

# VINCULAR POLLS AL PROYECTO (setting.py) VINCULA LAS APP 
...
"""
virtualenvwrapper
pip install virtualenvwrapper-win ----> INSTALACION EN LA TERMINAL

mkvirtualenv nombre_entono 
